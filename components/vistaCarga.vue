<template>
	<section id="vista_carga" class="hidden min-h-screen flex justify-center items-center">
		<article class="flex flex-wrap justify-center">
			...
			<h6 class="text-center font-bold w-full text-3xl my-4">Cargando...</h6>
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-12 h-12 animate-spin")
